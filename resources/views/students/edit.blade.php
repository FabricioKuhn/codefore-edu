<x-app-layout>
    ...
    <div class="py-12">
      ...
      x-data="{
          ...
          guardian_phone: '{{ old('guardian_phone', $student->guardian_phone) }}',
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="old('email', $student->email)" @blur="$el.value = $el.value.trim()" required />
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Preencha apenas se desejar redefinir a senha do aluno. A senha deve conter no mínimo 8 caracteres, letras, números e caracteres especiais.</p>
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <x-text-input id="cpf" name="cpf" type="text" class="mt-1 block w-full" x-model="cpf" x-mask="999.999.999-99" placeholder="000.000.000-00" @blur="$el.value = $el.value.trim()" maxlength="14" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" x-model="phone" x-mask:dynamic="$input.length <= 14 ? '(99) 9999-9999' : '(99) 99999-9999'" placeholder="(00) 00000-0000" @blur="$el.value = $el.value.trim()" maxlength="15" />
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="guardian_phone" name="guardian_phone" type="text" class="mt-1 block w-full" x-model="guardian_phone" x-mask:dynamic="$input.length <= 14 ? '(99) 9999-9999' : '(99) 99999-9999'" placeholder="(00) 00000-0000" @blur="$el.value = $el.value.trim()" maxlength="15" />
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <x-text-input id="zip_code" name="zip_code" type="text" class="mt-1 block w-full" x-model="zip_code" x-mask="99999-999" placeholder="00000-000" @blur="$el.value = $el.value.trim()" maxlength="9" />
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-2">Você pode selecionar mais de um arquivo. Eles serão adicionados aos já existentes. O arquivo deve ter no máximo 2MB.</p>
