...
<div class="p-8 max-w-6xl mx-auto">
    <nav class="flex text-gray-500 text-sm mb-4">
        <ol class="inline-flex items-center space-x-1">
            ...
            <li class="text-secondary font-bold">{{ isset($institution) ? 'Editar' : 'Novo Cadastro' }}</li>
        </ol>
    </nav>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 md:col-span-9">
                    ...
                    <input type="text" name="trading_name" value="{{ $institution->trading_name ?? old('trading_name') }}" class="w-full border-gray-300 rounded-md focus:border-primary focus:ring-0 text-sm">
                </div>
    ...
    <select name="plan_id" class="w-full border-gray-200 rounded-lg text-sm mt-1 focus:ring-primary focus:border-primary">
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('superadmin.institutions.index') }}" class="px-6 py-2 text-gray-500 font-bold hover:text-secondary transition">Cancelar</a>
            <x-primary-button>
